...
import CreateImageForm from '../form/CreateImageForm'
import CreateVideoForm from '../form/CreateVideoForm'

export default function VideoModal({mainButton,modalTitle,postId,onCreate}) {
                ...
                <Dialog.Panel className="w-full md:max-w-md  transform overflow-hidden rounded-lg bg-white  text-left align-middle shadow-xl transition-all">
                  ...
                  > 
                   ...
                   <MainCard className={'w-full bg-white'} mainTitle={modalTitle} 
                      ...
                      <div className="px-4">
                      <CreateVideoForm postId={postId} onCreate={onCreate}  onClose={closeModal}  />
                      </div>
